...
self.addEventListener('fetch', event => {
  const request = event.request; // solo get
...
async function precache() {
  ...
  return cache.addAll(['/', '/index.html', '/assets/main.js', '/assets/MediaPlayer.js', '/plugins/AutoPlay.js', '/plugins/AutoPause.js', '/assets/index.css', '/assets/big-buck-bunny.mp4']);
}
