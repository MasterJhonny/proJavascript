...
class AutoPause {
  ...
  handlerIntersection(entries) {
    ...
    const visibility = entry.intersectionRatio >= this.threshot; // console.log(entry.isIntersecting)

    if (visibility) {
      this.player.play(); // this.player.media.classList.remove('wien')
    } else {
      this.player.pause(); // this.player.media.classList.add('wien')
    }
  }
...
},{"./MediaPlayer.js":"assets/MediaPlayer.js","../plugins/AutoPlay.js":"plugins/AutoPlay.js","../plugins/AutoPause.js":"plugins/AutoPause.js","/home/eddyfu/cursos/programacion/profecionalJavascript/sw.js":[["sw.js","sw.js"],"sw.js.map","sw.js"]}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
